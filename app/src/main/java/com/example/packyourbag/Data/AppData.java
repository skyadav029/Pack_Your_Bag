...
public class AppData extends Application {
    ...
    public List<Items> getBasicData() {
        ...
        basicItem.clear(); basicItem.add(new Items ("Visa", category, false));
    ...
    public List<Items> getPersonalCareData() {
        ...
        String[] data = {"Tooth-brush", "Tooth-paste", "Floss", "Mouthwash", "Shaving Cream",
                "Razor Blade", "Soap", "Fiber", "Shampoo", "Hair Conditioner", "Brush",
                "Comb", "Hair Dryer", "Curling Iron", "Hair Moulder", "Hair Clip",
    ...
    public List<Items> getBabyNeedsData() {
        String [] data = {"Snapsuit", "Outfit", "Jumpsuit", "Baby Socks", "Baby Hat", "Baby Pyjamas",
                ...
                "Nasal Aspirator", "Fly Repellent Lotion", "Pyrometer", "Antipyretic Syrup", "Probiotic Power" ,"Baby Backpack", "Stroller", "Baby Carrier", "Toys", "Teether", "Playpen", "Playpen", "Baby Radio",
    ...
    public List<Items> getTechnologyData() {
        ...
        String []data= {"Mobile Phone", "Phone Cover", "E-Book Reader", "Camera", "Camera Charger",
                "Voltage Adapter", "SD Card", "Portable Speaker", "IPad (Tab)", "Headphone",
                "Laptop", "Laptop Charger", "Mouse", "Extension Cable", "Data Transfer Cable",
                "Battery", "Power Bank", "DVD Player", "Flash-Light", "MP3 Player",
                "MP3 Player Charger"};
    ...
    public List<Items> getNeedsData() {
        ...
        String[] data = {"Back  pack", "Daily Bags", "Laundry Bag", "Sewing Kit",
                "Travel Lock", "Luggage Tag", "Magazine", "Sports Equipment", "Important Numbers"};
    ...
    public  void  persistDataByCategory(String category,Boolean onlyDelete){
            try{
                ...
                Toast.makeText(context, category+"Something Went Wrong", Toast.LENGTH_SHORT).show();
            }
    }
...
//     this is for three dot code list as about as, create custom list  , delete
